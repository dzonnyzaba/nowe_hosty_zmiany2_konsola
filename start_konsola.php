...
class test{
    ...
    public function powysylaj(){
        ...
        if($r){
			...
			$this->zapiszDoLoga($tresc_maila);
			$this->wyslijEmail($tresc_maila);
	...
	private function wyslijEmail($wiadomosc){
...
class XML_do_bazy{
    ...
    public function wypelnijTabliceTmpiZnane(){
        ...
        $sql_tmp = "LOAD DATA LOCAL INFILE 'C:/xampp/htdocs/nowe_hosty/nowe_hosty_zmiany2_konsola/txt/$this->plik_xml_to_txt' IGNORE INTO TABLE tmp 
			FIELDS TERMINATED BY ',' LINES TERMINATED BY '\r\n' (@klucz, nowy_mac, nowy_ip, data, VLAN)";
        $sql_znane = "LOAD DATA LOCAL INFILE 'C:/xampp/htdocs/nowe_hosty/nowe_hosty_zmiany2_konsola/txt/$this->plik_input_conf_to_txt' IGNORE INTO TABLE  znane_hosty
...
class Roznice{
    ...
    public function TworzTabeleRoznice(){
		...
		$sql_roznice = "LOAD DATA LOCAL INFILE 'c:/xampp/htdocs/nowe_hosty/nowe_hosty_zmiany2_konsola/txt/roznice.txt' IGNORE INTO TABLE  roznice
			FIELDS TERMINATED BY ',' LINES TERMINATED BY '\r\n' (@klucz, nowy_mac, nowy_ip, data, VLAN)";
